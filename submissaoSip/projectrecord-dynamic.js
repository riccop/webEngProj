      ...
      //É possível adicionar até 5 elementos de uma equipa
       $("#adicionarTeamMember").click(function(){
           if(contTM<4){
               ...
               $("#membro"+contTM).append("<table id='table"+contTM+"'></table>"); //é necessário declarar a tabela dentro da div com id="membroX"
       ...
       $("#removerTeamMember").click(function(){
           if(contTM>0){
               ...
               alert("Atention: The team has at least 1 member!");
           }
       });
    });
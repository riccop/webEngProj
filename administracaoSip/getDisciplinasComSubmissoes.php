...
$query = $bd->query("SELECT DISTINCT disciplina.codUC, disciplina.designacao FROM disciplina, enunciado,projeto_submissao WHERE projeto_submissao.codEnunciado=enunciado.codEnunciado AND enunciado.codUC=disciplina.codUC");
